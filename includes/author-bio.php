...
add_action( 'genesis_after_entry', 'summation_genesis_author_bio', 8, 2 );
/**
 ...
 */
function summation_genesis_author_bio( $user_id = '', $url = '' ) {
	...
	if ( ! genesis_get_option( 'summation_genesis_enable_author_box' ) ) {
		return;
	}
