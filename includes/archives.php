...
//add_filter( 'post_class', 'summation_genesis_archive_post_class' );
function summation_genesis_archive_post_class( $classes ) {
...
add_action( 'genesis_entry_header', 'summation_genesis_post_archive_hover_content_open', 5 );
function summation_genesis_post_archive_hover_content_open() {
